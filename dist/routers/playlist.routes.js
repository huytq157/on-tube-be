...
router.post("/", verifyToken_1.verifyToken, playList_controller_1.addPlayList);
router.get("/list", verifyToken_1.verifyToken, playList_controller_1.getAllPlayList);
router.get("/user/:id", verifyToken_1.verifyToken, playList_controller_1.getPlaylistDetails);
router.get("/:id", playList_controller_1.getPlaylistById);
router.post("/save-to-playlist", verifyToken_1.verifyToken, playList_controller_1.saveVideoToPlaylist);
router.delete("/remove-to-playlist", verifyToken_1.verifyToken, playList_controller_1.removeVideoFromPlaylist);
router.patch("/:id", verifyToken_1.verifyToken, playList_controller_1.updatePlaylist);
router.delete("/:id", verifyToken_1.verifyToken, playList_controller_1.deletePlayList);
