...
router.post("/", authToken_1.authenticateToken, playList_controller_1.addPlayList);
router.get("/list", authToken_1.authenticateToken, playList_controller_1.getAllPlayList);
router.get("/user/:id", authToken_1.authenticateToken, playList_controller_1.getPlaylistDetails);
router.get("/:id", playList_controller_1.getPlaylistById);
router.post("/save-to-playlist", authToken_1.authenticateToken, playList_controller_1.saveVideoToPlaylist);
router.delete("/remove-to-playlist", authToken_1.authenticateToken, playList_controller_1.removeVideoFromPlaylist);
router.patch("/:id", authToken_1.authenticateToken, playList_controller_1.updatePlaylist);
router.delete("/:id", authToken_1.authenticateToken, playList_controller_1.deletePlayList);
