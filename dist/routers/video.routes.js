...
router.delete("/:id", verifyToken_1.verifyToken, video_controller_1.deleteVideo);
router.get("/favourite", verifyToken_1.verifyToken, favourite_controller_1.getVideoFavourite);
router.post("/favourite", verifyToken_1.verifyToken, favourite_controller_1.addVideoFavourite);
router.delete("/:videoId", verifyToken_1.verifyToken, favourite_controller_1.deleteVideoFavourite);
router.post("/add", verifyToken_1.verifyToken, video_controller_1.addVideo);
router.get("/:id", video_controller_1.getVideobyId);
router.patch("/:id", verifyToken_1.verifyToken, video_controller_1.updateVideo);
router.post("/watch/:id", video_controller_1.descView);
router.post("/watch/auth/:id", verifyToken_1.verifyToken, video_controller_1.descViewAuth);
router.get("/list/recommend/:id", video_controller_1.getVideoRecommend);
router.get("/user/:userId/history", verifyToken_1.verifyToken, video_controller_1.getWatchedVideos);
