...
router.get("/favourite", authToken_1.authenticateToken, favourite_controller_1.getVideoFavourite);
router.post("/favourite", authToken_1.authenticateToken, favourite_controller_1.addVideoFavourite);
router.delete("/:videoId", authToken_1.authenticateToken, favourite_controller_1.deleteVideoFavourite);
router.post("/add", authToken_1.authenticateToken, video_controller_1.addVideo);
router.get("/:id", video_controller_1.getVideobyId);
router.patch("/:id", authToken_1.authenticateToken, video_controller_1.updateVideo);
router.post("/watch/:id", video_controller_1.descView);
router.post("/watch/auth/:id", authToken_1.authenticateToken, video_controller_1.descViewAuth);
router.get("/list/recommend/:id", video_controller_1.getVideoRecommend);
router.get("/user/:userId/history", authToken_1.authenticateToken, video_controller_1.getWatchedVideos);
router.get("/:userId/video-count", video_controller_1.getUserVideoCount);
