...
router.post("/create", verifyToken_1.verifyToken, comment_controller_1.createComment);
router.delete("/:id", verifyToken_1.verifyToken, comment_controller_1.deleteComment);
router.put("/:id", verifyToken_1.verifyToken, comment_controller_1.updateComment);
router.post("/reply", verifyToken_1.verifyToken, comment_controller_1.replyComment);
