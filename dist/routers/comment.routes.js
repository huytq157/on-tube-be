...
router.post("/create", authToken_1.authenticateToken, comment_controller_1.createComment);
router.delete("/:id", authToken_1.authenticateToken, comment_controller_1.deleteComment);
router.put("/:id", authToken_1.authenticateToken, comment_controller_1.updateComment);
router.post("/reply", authToken_1.authenticateToken, comment_controller_1.replyComment);
router.get("/:video_id", comment_controller_1.getComments);
