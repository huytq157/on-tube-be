...
const uploaddrive_controller_1 = require("../controllers/uploaddrive.controller");
...
router.post("/file/drive", upload.array("files"), uploaddrive_controller_1.uploadFiles);
