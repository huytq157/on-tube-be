...
router.get("/list", category_controller_1.getAllCategories);
router.post("/add", category_controller_1.addedCategory);
router.get("/videos/:categoryId", category_controller_1.getVideobyCategory);
